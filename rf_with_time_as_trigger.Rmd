...
#Evaluate the +10s Model (Make Sure to Run "+10s" Chunk First)
```{r}
#Calculate Information Gain
...
#Evaluate the +20s Model (Make Sure to Run "+20s" Chunk First)
```{r}
#Calculate Information Gain
...
#Evaluate the +30s Model (Make Sure to Run "+30s" Chunk First)
```{r}
#Calculate Information Gain
...
summary.dt = data.frame(c("Train", "Test", "Train", "Test", "Train", "Test"),
           c(100*train_accurate3, 100*test_accurate3, 100*PIG_3_train, 100*PIG_3_test, FN_EL3[1,4], FN_EL3[3,4]) %>% round (1),
           c(100*train_accurate4, 100*test_accurate4, 100*PIG_4_train, 100*PIG_4_test, FN_EL4[1,4], FN_EL4[3,4]) %>% round(1),
           c(100*train_accurate5, 100*test_accurate5, 100*PIG_5_train, 100*PIG_5_test, FN_EL5[1,4], FN_EL5[3,4]) %>% round(1),
           c(100*train_accurate2, 100*test_accurate2, 100*PIG_2_train, 100*PIG_2_test, FN_EL2[1,4], FN_EL2[3,4]) %>% round(1))
colnames(summary.dt)[1] = "Set"
colnames(summary.dt)[2] = "10s"
colnames(summary.dt)[3] = "20s"
colnames(summary.dt)[4] = "30s"
colnames(summary.dt)[5] = "Full OP"
rownames(summary.dt)[1] = "Accuracy"
rownames(summary.dt)[2] = "  "
rownames(summary.dt)[3] = "P.I.G"
rownames(summary.dt)[4] = "    "
rownames(summary.dt)[5] = "FN_EL"
rownames(summary.dt)[6] = "      "
summary.dt
```
