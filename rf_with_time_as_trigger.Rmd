...
p1 = ggplot(data = result_trigger, aes(x = time_trigger, y = train_general_cost)) + 
  geom_point() +
  geom_line()+
  geom_smooth()
p2 = ggplot(data = result_trigger, aes(x = time_trigger, y = test_general_cost)) + 
  geom_point() +
  geom_line()+
  geom_smooth()
p3 = ggplot(data = result_trigger, aes(x = time_trigger, y = train_double_typing_cost)) + 
  geom_point() +
  geom_line()+
  geom_smooth()
p4 = ggplot(data = result_trigger, aes(x = time_trigger, y = test_double_typing_cost)) + 
  geom_point() +
  geom_line()+
  geom_smooth()
