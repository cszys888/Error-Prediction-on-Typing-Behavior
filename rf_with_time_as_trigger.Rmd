...
for (i in 1:50) {
  ...
  test_alt = test_alt %>%
    ...
    mutate(  CostA1 = 2*Task_Duration,
             ...
             CostC1 = Task_Duration*(2+(TP+FP)*1)+Triggered*i,
             CostC2 = (Triggered*((Task_Duration-CR*i)/(Task_Duration)) + Overtrigger*1)*(TP+TN)*(0.08*0.08))
    Breakeven_ME = (mean(test_alt$CostA1)-mean(test_alt$CostC1))/(mean(test_alt$CostC2)-mean(test_alt$CostA2));Breakeven_ME 
...
ggplot(data = result_trigger, aes(x = trigger, y = Breakeven_ME)) +
  geom_point() +
  geom_line()+
  geom_smooth()
...
p1 = ggplot(data = result_trigger, aes(x = trigger, y = train_PIG)) + 
  geom_point() +
  geom_line()+
  geom_smooth()
p2 = ggplot(data = result_trigger, aes(x = trigger, y = test_PIG)) + 
  geom_point() +
  geom_line()+
  geom_smooth()
p3 = ggplot(data = result_trigger, aes(x = trigger, y = Breakeven_MA)) + 
  geom_point() +
  geom_line()+
  geom_smooth()
p4 = ggplot(data = result_trigger, aes(x = trigger, y = Breakeven_ME)) + 
  geom_point() +
  geom_line()+
  geom_smooth()
