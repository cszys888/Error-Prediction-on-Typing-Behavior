---
title: "Random Forest with Worker Info"
...
Next_KeyType = dt1 %>% 
  select(keytype) %>%
  slice(2:nrow(dt1))
Next_KeyType[nrow(dt1),1] = 1

Next_Mouse = dt1 %>%
  select(mousemove,mouseclick) %>%
  slice(2:nrow(dt1))
Next_Mouse[nrow(dt1),1:2] = 0

dt2 = data.frame(dt1, Next_KeyType, Next_Mouse)
colnames(dt2)[13] = "NextType"
colnames(dt2)[14] = "NextMove"
colnames(dt2)[15] = "NextClick"
dt2 = dt2 %>% mutate(KeyTypeChange = 1*(keytype == NextType),
                     MouseChange = 1*(((mousemove=="Yes")+(mouseclick=="Yes")) != ((NextMove=="Yes")+(NextClick=="Yes"))))
...
dt2 = dt2 %>%
  ...
  summarise(duration = duration[1],
            ...
            TypeShift = sum(KeyTypeChange),
            MouseShift = sum(MouseChange),
            accuracy = accuracy[1],
...
#Summarise value added: FN_EL short for "False Negative Equivelent Loss"
FN_EL3 = data.frame(c(train_accurate3*100,PIG_3_train*100,test_accurate3*100,PIG_3_test*100) %>% round (2),
                    c("Double Typing","General","Double Typing","General"),    
                    c(0,1/M_counts_a,0,1/M_counts_e) %>% round(1),
                    c(((Double_Typing_Cost_a - Model_Cost1_a)/M_counts_a),((Omniscient_Cost_a - Model_Cost1_a)/M_counts_a),((Double_Typing_Cost_e - Model_Cost1_e)/M_counts_e),((Omniscient_Cost_e - Model_Cost1_e)/M_counts_e)) %>% round(1))

colnames(FN_EL3)[1] = "Accuracy & P.I.G (%)"
colnames(FN_EL3)[2] = "  "
colnames(FN_EL3)[3] = "Cost to Be Omniscient/Event"
colnames(FN_EL3)[4] = "Time Consumption/Event"
rownames(FN_EL3)[1] = "Train"
rownames(FN_EL3)[2] = "  "
rownames(FN_EL3)[3] = "Test"
rownames(FN_EL3)[4] = "    "
FN_EL3
#0+206/0+201
#5.1+57/5.6+54.6
...
n4 = names(dt4_keep)
f4 = as.formula(paste("accuracy~", paste(n4[!n4 %in% "accuracy"], collapse = "+")))
...
M_counts_a = mean(train_detail4$FN)
    #Test Set
Double_Typing_Cost_e = mean(test_detail4$Cost_Benchmark);Double_Typing_Cost_e
Omniscient_Cost_e = mean(test_detail4$Cost_Omniscient);Omniscient_Cost_e
Model_Cost1_e = mean(test_detail4$Cost_Model_ExcludingM);Model_Cost1_e
M_counts_e = mean(test_detail4$FN)

#Summarise value added: FN_EL short for "False Negative Equivelent Loss"
FN_EL4 = data.frame(c(train_accurate4*100,PIG_4_train*100,test_accurate4*100,PIG_4_test*100) %>% round (2),
                    c("Double Typing","General","Double Typing","General"),    
                    c(0,1/M_counts_a,0,1/M_counts_e) %>% round(1),
                    c(((Double_Typing_Cost_a - Model_Cost1_a)/M_counts_a),((Omniscient_Cost_a - Model_Cost1_a)/M_counts_a),((Double_Typing_Cost_e - Model_Cost1_e)/M_counts_e),((Omniscient_Cost_e - Model_Cost1_e)/M_counts_e)) %>% round(1))

colnames(FN_EL4)[1] = "Accuracy & P.I.G (%)"
colnames(FN_EL4)[2] = "  "
colnames(FN_EL4)[3] = "Cost to Be Omniscient/Event"
colnames(FN_EL4)[4] = "Time Consumption/Event"
rownames(FN_EL4)[1] = "Train"
rownames(FN_EL4)[2] = "  "
rownames(FN_EL4)[3] = "Test"
rownames(FN_EL4)[4] = "    "
FN_EL4
#0+225/0+193
#5.9+54.8/5.7+44.7
...
test5 = dt5_keep[-index5,]
  ...
  #build model on training data
n5 = names(dt5_keep)
f5 = as.formula(paste("accuracy~", paste(n5[!n5 %in% "accuracy"], collapse = "+")))
...
M_counts_a = mean(train_detail5$FN)
    #Test Set
Double_Typing_Cost_e = mean(test_detail5$Cost_Benchmark);Double_Typing_Cost_e
Omniscient_Cost_e = mean(test_detail5$Cost_Omniscient);Omniscient_Cost_e
Model_Cost1_e = mean(test_detail5$Cost_Model_ExcludingM);Model_Cost1_e
M_counts_e = mean(test_detail5$FN)

#Summarise value added: FN_EL short for "False Negative Equivelent Loss"
FN_EL5 = data.frame(c(train_accurate5*100,PIG_5_train*100,test_accurate5*100,PIG_5_test*100) %>% round (2),
                    c("Double Typing","General","Double Typing","General"),    
                    c(0,1/M_counts_a,0,1/M_counts_e) %>% round(1),
                    c(((Double_Typing_Cost_a - Model_Cost1_a)/M_counts_a),((Omniscient_Cost_a - Model_Cost1_a)/M_counts_a),((Double_Typing_Cost_e - Model_Cost1_e)/M_counts_e),((Omniscient_Cost_e - Model_Cost1_e)/M_counts_e)) %>% round(1))

colnames(FN_EL5)[1] = "Accuracy & P.I.G (%)"
colnames(FN_EL5)[2] = "  "
colnames(FN_EL5)[3] = "Cost to Be Omniscient/Event"
colnames(FN_EL5)[4] = "Time Consumption/Event"
rownames(FN_EL5)[1] = "Train"
rownames(FN_EL5)[2] = "  "
rownames(FN_EL5)[3] = "Test"
rownames(FN_EL5)[4] = "    "
FN_EL5
#0+226.9/0+202.0
#6.2+47.4/6.2+40.2
...
test6 = dt6_keep[-index6,]
  ...
  #build model on training data
n6 = names(dt6_keep)
f6 = as.formula(paste("accuracy~", paste(n6[!n6 %in% "accuracy"], collapse = "+")))
...
M_counts_a = mean(train_detail6$FN)
    #Test Set
Double_Typing_Cost_e = mean(test_detail6$Cost_Benchmark);Double_Typing_Cost_e
Omniscient_Cost_e = mean(test_detail6$Cost_Omniscient);Omniscient_Cost_e
Model_Cost1_e = mean(test_detail6$Cost_Model_ExcludingM);Model_Cost1_e
M_counts_e = mean(test_detail6$FN)

#Summarise value added: FN_EL short for "False Negative Equivelent Loss"
FN_EL6 = data.frame(c(train_accurate6*100,PIG_6_train*100,test_accurate6*100,PIG_6_test*100) %>% round (2),
                    c("Double Typing","General","Double Typing","General"),    
                    c(0,1/M_counts_a,0,1/M_counts_e) %>% round(1),
                    c(((Double_Typing_Cost_a - Model_Cost1_a)/M_counts_a),((Omniscient_Cost_a - Model_Cost1_a)/M_counts_a),((Double_Typing_Cost_e - Model_Cost1_e)/M_counts_e),((Omniscient_Cost_e - Model_Cost1_e)/M_counts_e)) %>% round(1))

colnames(FN_EL6)[1] = "Accuracy & P.I.G (%)"
colnames(FN_EL6)[2] = "  "
colnames(FN_EL6)[3] = "Cost to Be Omniscient/Event"
colnames(FN_EL6)[4] = "Time Consumption/Event"
rownames(FN_EL6)[1] = "Train"
rownames(FN_EL6)[2] = "  "
rownames(FN_EL6)[3] = "Test"
rownames(FN_EL6)[4] = "    "
FN_EL6
#0+219.8/0+176.0
#6.2+39.9/5.6+29.7
...
```{r}
summary.dt = data.frame(c(train_accurate3,PIG_3_train, FN_EL3[1,2], test_accurate3, PIG_3_test, FN_EL3[2,2]),
           c(train_accurate4, PIG_4_train, FN_EL4[1,2], test_accurate4, PIG_4_test, FN_EL4[2,2]),
           c(train_accurate5, PIG_5_train, FN_EL5[1,2], test_accurate5, PIG_5_test, FN_EL5[2,2]),
           c(train_accurate6, PIG_6_train, FN_EL6[1,2], test_accurate6, PIG_6_test, FN_EL6[2,2]),
           c(train_accurate2, PIG_2_train, FN_EL2[1,2], test_accurate2, PIG_2_test, FN_EL2[2,2]))
...
rownames(summary.dt)[3] = "Training - FN's Equivelent Loss (Time Cost)"
rownames(summary.dt)[4] = "Testing Accuracy"
rownames(summary.dt)[5] = "Testing PIG"
rownames(summary.dt)[6] = "Testing - FN's Equivelent Loss (Time Cost)"
summary.dt
```
