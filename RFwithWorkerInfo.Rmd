...
```{r}
df = fread('https://raw.githubusercontent.com/cszys888/BEGGER-DATA---Team-1/master/CloudFactory_DataSet_df_Prediction.tsv') 
...
#variable importance
varImpPlot(rf2)
>>>>>>> 5da1f188d74ea3bacc81574cf9ce657aa1a95c8c
```
...
for(i in 2:4){
 rotate_full = rbind(rotate_full,dt2[i,-2])
}
